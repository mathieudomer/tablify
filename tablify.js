...
var sortAscendingByInnerHMTLDate = function(a, b) {
	return moment(a.innerHTML, "DD/MM/YYYY").isAfter(moment(b.innerHTML, "DD/MM/YYYY"));
};
...
Tablify.prototype.thsClick = function(e) {
	...
	if ("" != direction) {
		...
		else if (moment(this.tbody.querySelector("tr td:nth-child(" + (index + 1) + ")").innerHTML).isValid()) {
			sortFunction = sortAscendingByInnerHMTLDate;
		}
	}
	else {
